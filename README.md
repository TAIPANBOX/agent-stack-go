...
```sh
go get github.com/TAIPANBOX/agent-stack-go@v1.0.2
```
...
```sh
go install github.com/TAIPANBOX/agent-stack-go/cmd/agent-conform@v1.0.2
...
by tag (`go get github.com/TAIPANBOX/agent-stack-go@v1.0.2`), never a local
`replace`.
